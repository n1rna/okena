...
pub use repository::{
    ...
    checked_out_branch, delete_local_branch, delete_remote_branch, discard_file_changes, fetch_all,
    fetch_and_fast_forward, finish_clone_repository, force_delete_local_branch,
